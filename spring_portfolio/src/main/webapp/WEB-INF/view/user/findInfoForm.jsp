...
<head>
	...
	<link href="../resources/css/findInfoForm.css" rel="stylesheet" >
</head>
<body>
<div class="mainDiv">
...
<!-- <script src="../resources/js/findInfoForm.js"></script> -->
<script>
$(function(){
	//	id찾기, pwd찾기 구분
	var state;
	...
	$('.findDiv').hide(); // 아이디, 비밀번호 찾기 클릭시 show
	...
	$('#findInfo').on('click',function(){
		if(state=='id'){ // 아이디 찾기 시
			if(($('#userName').val()!='')&&($('#userEmail').val()!='')){
				if(nameRegex.test($('#userName').val())==true){
